...
import { DetailedHTMLProps, FC, InputHTMLAttributes, PropsWithChildren, ReactNode, TextareaHTMLAttributes } from "react";
...
declare const MotionButtonBase: {
  ({
    ...
    children,
    ...rest
  }: HTMLMotionProps<"button">): react0.JSX.Element;
  displayName: string;
};
//#endregion
...
declare const Input: {
  ({
    ...
    className,
    ...props
  }: DetailedHTMLProps<InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>): react0.JSX.Element;
  displayName: string;
};
//#endregion
...
declare const getGlobalComponent: (name: keyof GlobalComponents) => GlobalComponents[keyof GlobalComponents];
